  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-black">
      <form onSubmit={handleSubmit(onSubmit)} className="w-4/12 p-4 border-4 border-customRed rounded shadow bg-customDark">
        <div className="mb-4">
          <label className="block mb-2 text-sm font-bold text-white">Designation</label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label className="block mb-2 text-sm font-bold text-white ">Company</label>
          <input
            type="text"
            className="w-full px-3 py-2 border-2 border-customRed rounded bg-transparent text-white "
        ...
        <div className="mb-4">
          <label className="block mb-2 text-sm font-bold text-white ">Year</label>
          <input
            type="numbrt"
            className="w-full px-3 py-2 border-2 border-customRed rounded bg-transparent text-white "
